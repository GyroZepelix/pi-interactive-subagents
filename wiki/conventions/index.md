...
- [Agent profiles](./agent-profiles.md): frontmatter fields, discovery precedence, role identity, and nested-spawn permissions evidenced by `README.md`, `agents/*.md`, and `pi-extension/subagents/index.ts`.
