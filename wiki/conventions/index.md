...
- [Runtime safety](./runtime-safety.md): default-deny tools, sandboxed resume, shell and live-input boundaries, and trusted CLI profiles evidenced by `pi-extension/subagents/index.ts`, `tmux.ts`, `session.ts`, and `subagent-capability-activation.ts`.
